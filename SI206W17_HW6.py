...
## There are tests for each problem; you should also follow the instructions
# for things to do in the code that cannot be tested with unit tests, 
#e.g. using certain structures.


## [PROBLEM 1]
print("\n\n***** Problem 1 *****")
## We've provided a definition of a class Student, similar to the one you 
#may have seen in lecture. 
## Add a method to class Student called write_programs which accepts one 
#optional parameter with a default value of 1, and adds the input integer
# to the self.num_programs instance variable.
...
pst = Student("Jay", 3, 2)
print(pst)  # This should print: My name is Jay, and I've been at UMich for 
#about 3 years. I got <some number 0-1000> of bonus points and I have 
#written 2 programs while here.
pst.shout("I'm doing awesome on this problem set.")  # This should print: 
#I'm doing awesome on this problem set.

## Feel free to add more testing code here to help you understand the 
#class definition, especially to try out your write_programs method...
...
## Define a function called personal_map. This function should do a very 
#similar thing to the Python built-in map function.
## It should take as input one function object (required), and one list 
#(required), in that order.
## The function should invoke the input function upon each element of the
# input list, and accumulate the return values to a new list.
...
## We've provided the function access_third_elem. Write a lambda function 
#that does exactly the same thing as access_third_elem (you can assume any 
    #input it would receive has at least 3 elements in it). Assign that 
#lambda function to the variable sample_func.

## Note that we cannot specifically test in the unit tests whether it is
# a lambda function, but you will not get points for this question unless 
#it is.
...
# A Student's programming_productivity is defined as that student's number
# of programs written divided by the years they have been at UMich.
...
## [PROBLEM 7]
print("\n\n***** Problem 7 *****")
# Create a list of tuples wherein each tuple has a student's name and 
#productivity value. Save the list of tuples in a variable called names_and_productivities. To do this, you should use a list comprehension (you may also use the zip function, and you may use any variables you have already created).
...
## [PROBLEM 8]
print("\n\n***** Problem 8 *****")
# Use the Python filter function to select the subset of programmers 
#who have names with 5 or more characters. (i.e. ["Albert","Dinesh",
...
## Define a function called readfiles, which accepts a list of filenames
# as input and yields each line in each of the file with that name, 
#assuming those files exist in the same directory as this program.

## Define a generator called len_check which accepts a generator of file 
#lines and returns a generator object of all the lines it's accepted whose 
#length is longer than 40 characters.

## Finally, write a function called main_filterer that accepts a list of 
#filenames (strings), and returns a generator of all the lines in those 
#files that are longer than 40 characters. The function should invoke the 
#other function and generator, readfiles and len_check.

## There is a test for this but an even more fun test is to uncomment the 
#code below which invokes the main_filterer function and prints each line
# from the generator without blank lines in between (that's what the comma 
    #is doing).

## The examples here http://anandology.com/python-practice-book/iterators.html 
#in your reading may be very helpful!

## We have provided files samplehw6_1.txt and samplehw6_2.txt for your use 
#for this problem, which hopefully you have downloaded, so you can test 
...
def main_filterer(alist):
    return list(len_check(readfiles(alist)))
